            ...
            <div className={styles.container}>
                <div className={styles.section1}>
                    <div className={styles.col1}>
                        <img src={services1} alt="Catering and Delivery" className={styles.serviceImage} />
                    ...
                    <div className={styles.col2}>
                        <img src={services2} alt="Gifts" className={styles.serviceImage} />
                        <div className={styles.colText}>
                    ...
                    <div className={styles.col3}>
                        <img src={services3} alt="Corporate Partnerships" className={styles.serviceImage} />
                        <div className={styles.colText}>
